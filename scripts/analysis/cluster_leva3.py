"""
Script para criar clusters adicionais (22-41) para Gemini Web
"""
import json
import shutil
import random
...
def main():
    ...
    # Dividir: Barbara (22-31), Natalia (32-41)
    barbara_new = sorted_clusters[21:31]
    natalia_new = sorted_clusters[31:41]
    ...
    print("\nBARBARA (22-31):")
    process_clusters(barbara_new, barbara_dir, 22)
    
    print("\nNATALIA (32-41):")
    process_clusters(natalia_new, natalia_dir, 32)
    
    print("\nSUCCESS: 20 novos clusters criados!")
