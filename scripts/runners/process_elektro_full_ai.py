#!/usr/bin/env python3
"""
Script FULL IA - ELEKTRO
Estratégia: Full IA (Gemini) nos 620 arquivos da pasta ELEKTRO.
"""
...
# Configurações
BASE_DIR = Path("C:/Projetos/Raizen/data/processed/ELEKTRO") # Pasta unificada
OUTPUT_CSV = Path("C:/Projetos/Raizen/output/datasets_consolidados/ELEKTRO/ELEKTRO_FULL.csv")
OUTPUT_XLSX = Path("C:/Projetos/Raizen/output/datasets/elektro/dataset_ELEKTRO_ENTREGA_OFICIAL.xlsx")
MODEL_NAME = "gemini-2.5-flash-lite"
MAX_WORKERS = 50 # Elektro tem só 620 arquivos, 50 workers é seguro. (Global tinha 3300)
...
def main():
    print("="*60)
    print(f"ELEKTRO FULL IA - {MAX_WORKERS} THREADS")
    print("="*60)
    ...
    print(f"Arquivos na pasta ELEKTRO: {len(files)}")
    ...
    if files:
        ...
        with ThreadPoolExecutor(max_workers=MAX_WORKERS) as executor:
            ...
            for future in as_completed(future_map):
                ...
                if data:
                    # Fix: Às vezes a IA retorna uma lista [{}]. Tratamos isso.
