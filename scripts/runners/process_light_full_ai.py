#!/usr/bin/env python3
"""
Script FULL IA - LIGHT
Estratégia: Full IA (Gemini) nos 426 arquivos da pasta LIGHT.
"""
...
# Configurações
BASE_DIR = Path("C:/Projetos/Raizen/data/processed/LIGHT") 
OUTPUT_CSV = Path("C:/Projetos/Raizen/output/datasets_consolidados/LIGHT/LIGHT_FULL.csv")
OUTPUT_XLSX = Path("C:/Projetos/Raizen/output/datasets/light/dataset_LIGHT_ENTREGA_OFICIAL.xlsx")
...
def main():
    print("="*60)
    print(f"LIGHT FULL IA - {MAX_WORKERS} THREADS")
    print("="*60)
    ...
    print(f"Arquivos na pasta LIGHT: {len(files)}")
